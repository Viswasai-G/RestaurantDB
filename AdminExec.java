...
public class Example1 {
	...
	public Example1(String dbname, String userid, String password) {
		cn = null;
		currentResults = null;
		currentItem = null;
		...
		try
		{
		    ...
		    case 1:
				...
				Statement st1 = cn.createStatement();
				ResultSet rs1 = st1.executeUpdate("insert into employee_list values('" +customer +"','" +order +"','" +employee +"','" +bill +"','" +chef +"')");
				st1.close();
				Statement st2= cn.createStatement();
				ResultSet rs2= st2.executeUpdate("insert into order_details values ('" +customer +"','" +item +"')");
			    }
			    catch (SQLException e) {
				System.out.println("Query failed: " + e);
			    }
		    ...
		    try
				...
				int bill= bil.nextInt();
				Statement st1 = cn.createStatement();
				ResultSet rs1 = st1.executeUpdate("insert into employee_list values('" +customer +"','" +order +"','" +employee +"','" +bill +"')");
				st1.close();
		    ...
		    case 4:
				...
				Statement st1 = cn.createStatement();
				ResultSet rs1 = st1.executeUpdate("delete from employee_list where employee_id='" +val2 +"'");
				Statement st2 = cn.createStatement();
				ResultSet rs2= st2.executeUpdate("delete from manager_list where employee_id='" +val2 +"'");
				while (rs1.next())
				{
		    ...
		    case 5:
				...
				int val2= val1.nextInt();
				Statement st1 = cn.createStatement();
				ResultSet rs1 = st1.executeUpdate("delete from chef_list where chef_id='" +val2 +"'");
				while (rs1.next())
				{
		    ...
		    case 6:
				...
				ResultSet rs1 = st1.executeUpdate("delete from employee_list where employee_id='" +val2 +"'");
				Statement st2 = cn.createStatement();
				ResultSet rs2 = st2.executeUpdate("delete from waiter_list where employee_id='" +val2 +"'");
				while (rs1.next())
				{
	...
	public static void main (String[] args) {
		...
		String userid = "viswasai";
		String password = "zooghoow";

		Example1 app = new Example1(dbname, userid, password);
